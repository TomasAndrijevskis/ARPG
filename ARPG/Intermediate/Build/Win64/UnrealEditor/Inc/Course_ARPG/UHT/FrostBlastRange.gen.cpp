...
struct Z_CompiledInDeferFile_FID_projects_GIT_HUB_ARPG_ARPG_Source_Course_ARPG_Public_Combat_Abilities_FrostBlastRange_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AFrostBlastRange, AFrostBlastRange::StaticClass, TEXT("AFrostBlastRange"), &Z_Registration_Info_UClass_AFrostBlastRange, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFrostBlastRange), 2027322365U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_projects_GIT_HUB_ARPG_ARPG_Source_Course_ARPG_Public_Combat_Abilities_FrostBlastRange_h_877641336(TEXT("/Script/Course_ARPG"),
