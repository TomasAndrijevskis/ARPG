...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAbilityComponent_FrostBlast_Statics::NewProp_SlowDuration = { "SlowDuration", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAbilityComponent_FrostBlast, SlowDuration), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SlowDuration_MetaData), NewProp_SlowDuration_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAbilityComponent_FrostBlast_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAbilityComponent_FrostBlast_Statics::NewProp_SlowDuration,
};
...
struct Z_CompiledInDeferFile_FID_projects_GIT_HUB_ARPG_ARPG_Source_Course_ARPG_Public_Combat_Abilities_AbilityComponent_FrostBlast_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityComponent_FrostBlast, UAbilityComponent_FrostBlast::StaticClass, TEXT("UAbilityComponent_FrostBlast"), &Z_Registration_Info_UClass_UAbilityComponent_FrostBlast, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityComponent_FrostBlast), 1988477631U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_projects_GIT_HUB_ARPG_ARPG_Source_Course_ARPG_Public_Combat_Abilities_AbilityComponent_FrostBlast_h_4156813681(TEXT("/Script/Course_ARPG"),
