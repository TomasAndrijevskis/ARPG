...
struct Z_Construct_UClass_UAbilityComponent_FireStorm_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_BurnRate_MetaData[] = {
		{ "Category", "AbilityComponent_FireStorm" },
		{ "ModuleRelativePath", "Public/Combat/Abilities/AbilityComponent_FireStorm.h" },
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_BurnRate;
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAbilityComponent_FireStorm_Statics::NewProp_BurnRate = { "BurnRate", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAbilityComponent_FireStorm, BurnRate), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BurnRate_MetaData), NewProp_BurnRate_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAbilityComponent_FireStorm_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAbilityComponent_FireStorm_Statics::NewProp_BurnRate,
};
