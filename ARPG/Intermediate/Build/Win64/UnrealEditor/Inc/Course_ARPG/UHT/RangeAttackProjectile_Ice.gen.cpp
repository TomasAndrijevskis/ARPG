...
struct Z_CompiledInDeferFile_FID_projects_GIT_HUB_ARPG_ARPG_Source_Course_ARPG_Public_Combat_Projectiles_RangeAttackProjectile_Ice_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ARangeAttackProjectile_Ice, ARangeAttackProjectile_Ice::StaticClass, TEXT("ARangeAttackProjectile_Ice"), &Z_Registration_Info_UClass_ARangeAttackProjectile_Ice, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ARangeAttackProjectile_Ice), 1893526458U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_projects_GIT_HUB_ARPG_ARPG_Source_Course_ARPG_Public_Combat_Projectiles_RangeAttackProjectile_Ice_h_350824663(TEXT("/Script/Course_ARPG"),
