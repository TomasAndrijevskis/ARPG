...
void AEnemyCharacter_Minion::Tick(float DeltaTime)
{
...
void AEnemyCharacter_Minion::DetectPawn(APawn* DetectedPawn, APawn* PawnToDetect, EEnemyStates NewEnemyState)
{
	if (BlackboardComp)
	{
...
void AEnemyCharacter_Minion::BeginPlay()
{
	Super::BeginPlay();
